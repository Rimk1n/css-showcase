...
A modern React-based catalog of creative CSS effects with live demos, code viewing, and copying functionality.
...
4. Copy CSS or HTML code with one click
5. Export to CodePen for further experimentation
6. Save favorite effects to your personal collection

### Installation

```bash
# Clone the repository
git clone https://github.com/rimk1n/css-showcase.git
cd css-showcase
...
- Неоновые эффекты
- Интерактивные состояния наведения
...
4. Копируйте CSS или HTML код одним кликом
5. Экспортируйте в CodePen для дальнейших экспериментов
6. Сохраняйте понравившиеся эффекты в личную коллекцию
